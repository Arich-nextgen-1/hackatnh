...
const features = [
  {
    icon: Brain,
    title: 'AI-маршрутизация пациента',
    description:
      'Искусственный интеллект анализирует симптомы, медицинский профиль и историю болезней, чтобы построить персональный маршрут лечения — от диагностики до выздоровления.',
    color: '#2563EB',
    bg: 'rgb(37 99 235 / 0.08)',
    highlights: ['Анализ симптомов', 'Персональный маршрут', 'Приоритизация'],
  },
  {
    icon: MapPin,
    title: 'Подбор клиник',
    description:
      'База данных аккредитованных клиник с актуальными рейтингами, специализациями и расписанием. Фильтрация по профилю пациента и расстоянию.',
    color: '#06B6D4',
    bg: 'rgb(6 182 212 / 0.08)',
    highlights: ['340+ клиник', 'Рейтинги и отзывы', 'Фильтр по специализации'],
  },
  {
    icon: Activity,
    title: 'Реабилитационные центры',
    description:
      'Поиск и запись в реабилитационные центры на основе диагноза. Сравнение программ, мощностей и стоимости восстановительного лечения.',
    color: '#059669',
